...
class _GuardGateDashboardScreenState extends State<GuardGateDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tower Gate - A1'),
        centerTitle: true,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Incident reported to Supervisor'),
                  backgroundColor: Colors.red,
                ),
              );
            },
  ...
  void _showChecklist() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Duty Checklist'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            CheckboxListTile(
              title: const Text('Gate secured'),
              value: true,
              onChanged: (value) {},
            ),
            CheckboxListTile(
              title: const Text('Uniform clean'),
              value: true,
              onChanged: (value) {},
            ),
            CheckboxListTile(
              title: const Text('Emergency kit ready'),
              value: false,
              onChanged: (value) {},
            ),
            CheckboxListTile(
              title: const Text('Visitor log updated'),
              value: true,
              onChanged: (value) {},
            ),
          ],
