...
void main() async {
  ...
  runApp(const GatelyVisitorApp());
}

class GatelyVisitorApp extends StatelessWidget {
  const GatelyVisitorApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Gately Visitor',
      theme: ThemeData(
              ...
              return Scaffold(
                body: Center(
                  child: Column(
                    ...
                    children: [
                      const Text(
                        'This app is for Security Staff only.',
